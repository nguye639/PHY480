...
set term xterm  #title "Time Dependence"  # plot window 1
set timestamp
...
# phase space plot
set term xterm  #title "Phase Space"  # plot window 2
set timestamp
...
# plot the potential
set term xterm  #title "Potential V(x)"  # plot window 3
set timestamp
...
set term xterm  #title "Energy"  # plot window 4
set timestamp
